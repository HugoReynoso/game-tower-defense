export type EnemyId='slime'|'runner'|'beetle'|'boss'|'ghost'|'firebeast'|'swarm'|'mushroom'|'golem';export type TowerId='archer'|'cannon'|'frost'|'fire'|'lightning'|'poison'|'magic'|'bomb'|'nature'|'sun';export type TargetMode='FIRST'|'LAST'|'STRONGEST'|'WEAKEST'|'CLOSEST';
