export type EnemyId='slime'|'runner'|'beetle'|'boss';export type TowerId='archer'|'cannon'|'frost'|'fire'|'lightning';export type TargetMode='FIRST'|'LAST'|'STRONGEST'|'WEAKEST'|'CLOSEST';
